...
public class DirectoryListing {
    ...
    public List<String> listTo(String contextPath, File dir, Writer out, String path, List<String> files)
        ...
        out.write("<table id=\"dirlist\" style=\"width: 100%;\">\n");
        out.write("<thead>\n<tr><th/><th>文件名</th><th style=\"min-width:100px\">日期</th><th style=\"min-width:100px\">大小</th>");
        if (offset > 0) {
        ...
        Format dateFormatter = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault());
